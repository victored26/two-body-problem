...
class Menu_Page:
    ...
    def __init__(self, app):
        ...
        # <!--Draw the figure, labels and entries for the first body--!>
        ...
        # <!--Draw the figure, label and dropdown for eccentricity--!>
        ...
        # <!--Draw the figure, labels and entries for the second body--!>
